...
//Exemplo de entrada:
//Número de vagões: 8
//Sequência de vagões: abcdefgh ou ABCDEFGH (Se colocar D ou d com espaço, ou seja, A B C D E ou a b c d e, ele vai interpretar o D ou d como operação D(ireita))
//Sequência de operação: EEEDEEDDDEDEE
